<?php
$id=$_GET['emp_id'];
$qry = mysqli_query($connection, "SELECT * FROM emp_login where id='$id'and user_role='employee'");
$count = 0;
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group"><label for="">Profile</label>
                        <img id="preview" src="user_profile/<?php echo $emp_pro;?>" height="80px" width="80px">
                        <input onchange="readURL(this);" name="profile" type="file">
                    </div>
                </div>
                <div class="col-sm-3">
