<div class="element-box">
    ...
    <form class="container" action="#" method="post" enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="form-group"><label for="">Employee ID</label>
            ...
            <div class="col-sm-3">
                <div class="form-group"><label for="">Gst NO.</label>
                    <input class="form-control" name="mobile" placeholder="Gst No." type="text">
                </div>
            </div>
            ...
            <div class="form-buttons-w text-right">
                <input class="btn btn-primary" type="submit" value="Add Vendor" name="submit">
            </div>
        </div>
    </form>
</div>