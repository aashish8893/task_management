                        ...
                        <li class=" has-sub-menu">
                         ...
                         <li class=" has-sub-menu">
                            ...
                            <div class="sub-menu-w">
                                ...
                                <div class="sub-menu-i">
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="task_create.php">Create Task</a></li>
                                        <li><a href="task_list.php">Task List</a></li>
                                        <li><a href="task_assign.php">Assign Task</a></li>
                                        <li><a href="task_assign_list.php">Employee Task List</a></li>  
                                        <li><a href="task_assign_list_open.php">Open Task</a></li>  
                                        <li><a href="task_assign_list_close.php">Close Task</a></li>  
                                        <li><a href="task_assign_list_wip.php">WIP(Work In Process) Task</a></li>  
                                        <li><a href="task_assign_list_cancel.php">Cancel Task</a></li>  
                                    </ul>
                                </div>
                            </div>
                        </li>
                            ...
                            <a href="#">
                                <div class="icon-w">
                                    <div class="os-icon os-icon-wallet-loaded"></div>
                                </div><span>Distric Site Creation</span></a>
                            <div class="sub-menu-w">
                                <div class="sub-menu-header">Distric Site Creation</div>
                                <div class="sub-menu-icon"><i class="os-icon os-icon-wallet-loaded"></i></div>
                                <div class="sub-menu-i">
                                    <ul class="sub-menu">
                                            <li><a href="assets_add.php">Add Site</a></li>
                                         <li><a href="assets_list.php">Site List</a></li>
                                           <li><a href="assets_emp_assign.php">Assign Employee Site</a></li>  
                                            <li><a href="assign_emp_assets_list.php">Assign Employee Site List</a></li>  
                                            <li><a href="assign_emp_assets.php">Assign Employee Asset</a></li>  
