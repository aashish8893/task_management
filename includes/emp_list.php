      ...
      <table id="example" style="width: 100%" class="display table table-bordered table-responsive" style="width:100%">
        <thead>
          <tr>
            ...
            <th>Date</th>
            <th>Status</th>            
            <th rowspan='2'; style="width: 100%">Action</th>
          </tr>
        </thead>
        <tbody>
          <?php
          ...
          <tr>
            ...
            <td><a class="btn btn-primary" href="employee.php?source=update_emp&emp_id=<?php echo $id;?>">Edit</a>
            <a class="btn btn-danger" href="employee.php?delete=<?php echo $id;?>">Delete</a></td>
          </tr>
          <?php }?>
        </tbody>
      </table>
