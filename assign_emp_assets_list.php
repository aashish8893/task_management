...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item"><span>Assiged Site </span></li>
</ul>
<!--------------------
END - Breadcrumbs
-------------------->
...
<div class="content-i">
    <div class="content-box">
        <div class="element-wrapper">
            <div class="element-box">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h5 style="color: blue;border-bottom: 1px solid blue;padding: 10px;">Assiged Site List</h5>                                   
                    </div>  
                </div>
                <div class="container">
        ...
        <tbody>
    <?php
        $qry = mysqli_query($connection, "SELECT * FROM emp_assets order by created_date desc");
        $count = 0;
        ...
        $created    = $row['created'];
        $csno       ='';
        $qry2       = mysqli_query($connection, "SELECT * FROM asset_tb where assetID='$asset_id'");
    ...
    <tr>
        ...
        <td>
            <?php 
                $res = mysqli_query($connection,$app_code_obj->userIdbyUserName($emp_id));
